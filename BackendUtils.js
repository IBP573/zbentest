...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `.gg/test<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/testzben) Block Dash 1v1",
      descriptionKey: "Practice your skills in the zbenTest TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/zbentest) Block Dash Legendary 1v1",
      descriptionKey: "Practice your skills in the zbenTest TournamentX! mode!",
      ...
      headerColour: "#007799",
      mapListGradientColourTop: "rgb(17, 0, 255)",
      mapListGradientColourBottom: "#2b00ff",
      listPriority: 0,
      minPlayers: 2,
      maxPlayers: 2,
      maxRounds: 1,
      ...
      colourData: {
        detailsPanelMainColour: "#003366",
        detailsPanelBorderColour: "rgb(0, 157, 255)",
        headerGradientRight: "rgb(34, 0, 255)",
        headerGradientLeft: "rgb(8, 0, 255)",
        infoWidgetsGradientRight: "rgb(0, 26, 255)",
        infoWidgetsGradientLeft: "rgb(17, 0, 255)",
        infoWidgetsBorderColour: "rgb(13, 0, 255)"
      },
      rounds: [
        {
          roundOrder: 1,
